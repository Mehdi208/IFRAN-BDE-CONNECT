...
import { MessageCircle, Users, ClipboardList, X, AlertCircle, Eye, PlusCircle, Film } from 'lucide-react';
...
const Clubs = () => {
  ...
  }, [clubs]); // Redéclenche quand les clubs sont chargés
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-blue-50 border-l-4 border-bde-navy text-bde-navy p-4 rounded-r-lg mb-12 reveal active" style={{transitionDelay: '100ms'}}>
            <div className="flex items-center gap-4">
              <Film size={24} className="shrink-0" />
              <div>
                  <h3 className="font-bold">Participer aux Soirées Cinéma</h3>
                  <p className="text-sm">Pour être informé(e) des prochaines projections et participer, rejoins le Club Cinéma ci-dessous !</p>
              </div>
            </div>
        </div>
              ...
              <div className="mt-auto pt-6 border-t border-gray-100 space-y-4">
                ...
                <div className="flex items-center justify-between gap-2">
                  <button 
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-bde-navy text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-900 transition shadow-md"
                  >
